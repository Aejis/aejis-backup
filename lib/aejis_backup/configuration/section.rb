    ...
    class Section
      ...
      def storage(name, &block)
        ...
        required_storage = case name.to_sym
          when :cloudfiles
            AejisBackup::Storage::CloudFiles
          when :dropbox
            AejisBackup::Storage::Dropbox
          when :ftp
            AejisBackup::Storage::Ftp
          when :local
            AejisBackup::Storage::Local
          when :s3, :amazon
            AejisBackup::Storage::S3
          when :scp
            AejisBackup::Storage::Scp
          when :sftp
            AejisBackup::Storage::Sftp
          else
